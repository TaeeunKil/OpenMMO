...
export interface BridgeMeta {
  ...
  /** Deck-top Y sampled at uniform t along the deckAxis, t=0 (center) to
   *  t=1 (end). Generated by `tools/sample-bridge-decks.mjs` from the GLB.
   *  Used by bridgeManager during the brief async window between placement
   *  load and GLB load; once the model is registered, runtime ray-casting
   *  takes over and these samples are unused. */
  deckYSamples?: number[]
}
