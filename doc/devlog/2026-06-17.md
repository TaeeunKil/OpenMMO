...
## Dungeon Props from the FPS Dungeon Extras Pack

A set of dungeon dressing assets to scatter through the underground levels. These
come from the **FPS Dungeon Extras** pack on Sketchfab:

<https://sketchfab.com/3d-models/fps-dungeon-extras-87425249dded42aa891516c31a5b94cf>

![FPS Dungeon Extras assets laid out in Blender — a banded chest, a stool, a bucket, a barrel, a crate, and a broken stool](images/dungeon-props-blender.png)

The pack gives us a chest, a stool, a bucket, a barrel, a crate, and a broken
stool — the kind of clutter that makes a dungeon room read as lived-in. The plan
is to register these as props placeable inside dungeons.

### Scaling the chair to the character

The pack's assets don't ship at our world scale, so each one has to be sized
against an in-game character before it reads right. Here the chair is scaled
next to the player model until the seat height lines up with the character —
roughly where you'd actually sit.

![The chair placed beside the player character in Blender for scale — sized so the seat height matches the character](images/dungeon-prop-chair-scale.png)
